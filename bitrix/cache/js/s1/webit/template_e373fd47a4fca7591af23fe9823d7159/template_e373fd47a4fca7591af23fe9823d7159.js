...
; /* Start:"a:4:{s:4:"full";s:62:"/local/templates/webit/js/jquery-latest.min.js?159013789295786";s:6:"source";s:46:"/local/templates/webit/js/jquery-latest.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:55:"/local/templates/webit/js/jquery-ui.js?1590137892252417";s:6:"source";s:38:"/local/templates/webit/js/jquery-ui.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:61:"/local/templates/webit/js/owl.carousel.min.js?151778794179152";s:6:"source";s:45:"/local/templates/webit/js/owl.carousel.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/**
 * Owl carousel
 * @version 2.0.0
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:60:"/local/templates/webit/js/jquery.fancybox.js?151778793552723";s:6:"source";s:44:"/local/templates/webit/js/jquery.fancybox.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
// ==================================================
// fancyBox v3.1.28
//
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:51:"/local/templates/webit/js/imask.js?1559718999137514";s:6:"source";s:34:"/local/templates/webit/js/imask.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:79:"/local/templates/webit/js/jquery.mCustomScrollbar.concat.min.js?155843771645479";s:6:"source";s:63:"/local/templates/webit/js/jquery.mCustomScrollbar.concat.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:62:"/local/templates/webit/js/jquery.formstyler.js?151778793740414";s:6:"source";s:46:"/local/templates/webit/js/jquery.formstyler.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/*
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:48:"/local/templates/webit/js/menu.js?15906501353693";s:6:"source";s:33:"/local/templates/webit/js/menu.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
jQuery(function($){

    if (window.innerWidth < 768) {
        var $elements = $('#nav .cf .hd');
        var $selected = $elements.filter('.selected');

        var $subElements = $elements.find('.subn li');
        var $subElementSelected = $elements.find('.selected');

        $elements.hover(function (event, element) {
            $elements.removeClass('selected');
        }, function(event, element) {
            $selected.addClass('selected');
        });
        $subElements.hover(function (event, element) {
            $subElementSelected.removeClass('selected');
        }, function(event, element) {
            $subElementSelected.addClass('selected');
        });

        $('#nav .cf .hd .item--ic').on('click', function(event, element) {
            if (window.innerWidth <= 1023) {
                $(this).parents('.hd').find('.subn').css({opacity: 1, visibility: 'visible', pointerEvents: 'auto', zIndex: 2000});
                event.preventDefault();
                $('body').addClass('menu3level');
            }
        });

        $('.link-back').on('click', function (event, element) {
            $(this).parents('.subn').css({'opacity': 0, visibility: 'hidden', pointerEvents: 'none', zIndex: 2000});
            event.preventDefault();
            $('body').removeClass('menu3level');
        });
    }

    // $(window).on('resize', function (event) {
    //     if (window.innerWidth > 1023) {
    //         $elements.find('.subn').attr('style', '');
    //     }
    // });

    $('.open_nav_btn').on('click', function(event){
        $elements.find('.subn').attr('style', '');
    });
    ...
    if (window.matchMedia("(min-width: 767px)").matches) {
        $('#nav > ul li').hover(function () {
            ...
            $('.drop',this).stop(true,true).slideDown(300);
        }, function () {
            $.data(this,'timer', setTimeout($.proxy(function() {
                $('.drop',this).stop(true,true).slideUp(300);
            }, this), 100));
        });
        if($(".header__bot-nav-item").hasClass('sub')){
          $('.header__bot-nav-item').hover(function () {
              clearTimeout($.data(this,'timer'));
              $('.header__bot-submenu',this).stop(true,true).slideDown(200);
           }, function () {
             $.data(this,'timer', setTimeout($.proxy(function() {
               $('.header__bot-submenu',this).stop(true,true).slideUp(200);
             }, this), 100));
           });
        }
        if($(".header__bot-submenu-item").hasClass('sub')){
          $('.header__bot-submenu-item').hover(function () {
              clearTimeout($.data(this,'timer'));
              $('.header__submenu-third',this).stop(true,true).slideDown(200);
           }, function () {
             $.data(this,'timer', setTimeout($.proxy(function() {
               $('.header__submenu-third',this).stop(true,true).slideUp(200);
             }, this), 100));
           });
        }
    ...
    $('#m-menu').on('click', function(e){
      e.preventDefault();
      $('.header__m-menu-sub').toggleClass('active');
      $('.header__menu-icon').toggleClass('open');
    });
    $('.header__m-show-menu').on('click', function(e){
      e.preventDefault();
      $('.header__m-submenu').not($(this).siblings('.header__m-submenu')).hide("slow");
      $('.header__m-show-menu').not($(this)).removeClass('open');
      $(this).toggleClass('open');
      $(this).siblings('.header__m-submenu').slideToggle("slow");
    });
    $('.header__m-submenu-btn').on('click',function(e){
      e.preventDefault();
      $(this).toggleClass('open');
      $('.m-submenu__third').slideToggle();
    })
        
});
/* End */
;
; /* Start:"a:4:{s:4:"full";s:60:"/local/templates/webit/js/progressbar.min.js?155843771622540";s:6:"source";s:44:"/local/templates/webit/js/progressbar.min.js";s:3:"min";s:44:"/local/templates/webit/js/progressbar.min.js";s:3:"map";s:48:"/local/templates/webit/js/progressbar.min.js.map";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:51:"/local/templates/webit/js/global.js?160164832653544";s:6:"source";s:35:"/local/templates/webit/js/global.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
$(document).ready(function() {
  $('#y-block-5__carousel').owlCarousel({
    loop: true,
    nav: true,
    autoplay: true,
  ...
  $('#s-block-4__carousel').owlCarousel({
    loop: true,
    nav: true,
    autoplay: true,
    autoplayTimeout: 8000,
  ...
  function moveHead() {
    if (window.matchMedia('(max-width:1280px)').matches) {
      $('.z-block-7__subtitle').prependTo('.z-block-7__column.last');
    } else {
      $('.z-block-7__subtitle').appendTo('.z-block-7__column-right');
    }
    if (window.matchMedia('(max-width:767px)').matches) {
      $('.z-block-5__desc').appendTo('.z-block-5__wrapper');
    } else {
      $('.z-block-5__desc').appendTo('.z-block-5__column:last-child');
    }
    if (window.matchMedia('(max-width:767px)').matches) {
      $('.z-block-2__title').prependTo('.z-block-2');
    } else {
      $('.z-block-2__title').prependTo('.z-block-2__wrapper');
    }
  }
  moveHead();
  ...
  var sync1 = $('#z-block-6__carousel-big');
  var sync2 = $('#z-block-6__carousel-small');
  $('.z-block-6__btn.next').on('click', function () {
    sync2.trigger('next.owl.carousel');
    sync1.trigger('next.owl.carousel');
  });
  $('.z-block-6__btn.prev').on('click', function () {
  ...
  function syncPosition(el){
    ...
    $("#z-block-6__carousel-small")
      .find(".owl-item")
      .removeClass("synced")
      .eq(current)
      .addClass("synced")
    if($("#z-block-6__carousel-small").data("owlCarousel") !== undefined){
      center(current)
    }
  }
  ...
  function center(number){
	...
	$('#mobile-social-tab-1').click(function() {
		$(this).toggleClass('active');
	});
	$('#mobile-social-tab-2').click(function() {
		$(this).toggleClass('active');
	});
	$('#mobile-social-tab-3').click(function() {
		$(this).toggleClass('active');
	});
	$('#mobile-social-tab-4').click(function() {
		$(this).toggleClass('active');
	});

	$('.owl-carousel.commerce-carousel').owlCarousel({
		loop: true,
		nav: true,
		animateOut: 'fadeOut',
		autoplay: true,
	...
	$('#slider').slider({
		...
		slide: function(event, ui) {
			console.log(ui);
			$('#target_calc .amount').val(ui.value == 4000 ? ui.value + '+' : ui.value);
			calculate();
		},
	});
	$('#target_calc .amount').val('$' + $('#slider').slider('value'));
	//$( ".amount" ).val("1000");
	$('#slider > a').append(val);
	$('#slider > .value input').val('1000');
	$('#slider > .value').remove();
	$('#slider > .value').draggable();

	var val = $('#slider1').html();
	$('#slider1').slider({
		value: 40000,
		min: 40000,
		max: 150000,
		step: 10000,
		slide: function(event, ui) {
			$('#programmatic_calc .amount').val(ui.value);
			calculate_programmatic();
		},
	});

	$('#programmatic_calc .amount').val('$' + $('#slider1').slider('value'));
	// $( ".amount" ).val( "$" + $( "#slider1" ).slider( "value" ) );
	$('#slider1 > a').append(val);
	$('#slider1 > .value input').val('30000');
	$('#slider1 > .value').remove();
	$('#slider1 > .value').draggable();

	$('.partners-list').masonry({});
});
...
jQuery(document).ready(function($) {
	...
	$('.owl-carousel.main-carousel').on('resized.owl.carousel', function(event) {
		var $this = $(this);
		$this.find('.owl-height').css('height', $this.find('.owl-item.active').height());
	});
	var result_carousel;
	$('.owl-carousel.shops-carousel').owlCarousel({
		loop: true,
		margin: 0,
		nav: true,
		dots: true,
	...
	var result_carousel = $('.blocks-result .owl-carousel').owlCarousel({
		center: true,
		loop: true,
		autoWidth: true,
		items: 1,
	...
	var owl = $('.owl-carousel.progress-info');
	owl.owlCarousel({
		loop: true,
		margin: 40,
		nav: true,
	...
	owl.on('click', '.owl-next', function(event) {
		...
		// 		var scrollTop = $('.progress-section').offset().top - 97;
		// 	} else if ( $('body').hasClass('scrolling-down') ) {
		// 		var scrollTop = $('.progress-section').offset().top - 63;
		// 	}
		// }
		// if ( $('.examples-area').length>0 ) {
		// 	if ( $('body').hasClass('scrolling-up') ) {
		// 		var scrollTop = $('.examples-area').offset().top - 141;
		// 	} else if ( $('body').hasClass('scrolling-down') ) {
		// 		var scrollTop = $('.examples-area').offset().top - 44;
		// 	}
		// }
		if (
			$(this)
				.closest('.owl-carousel')
				.hasClass('progress-slide') ||
			$(this)
				.closest('.owl-carousel')
				.hasClass('progress-info')
		) {
			owl.trigger('next.owl.carousel');
		} else {
			var scrollTop = $('.jsTitle').offset().top - 22;
	...
	$('.owl-carousel.advantages-gallery').owlCarousel({
		loop: true,
		nav: false,
		animateOut: 'fadeOut',
		autoplay: true,
	...
	$('.audit-gallery .owl-carousel').owlCarousel({
		loop: true,
		nav: true,
		dots: false,
		animateOut: 'fadeOut',
	...
	$('.tools-gallery.owl-carousel').owlCarousel({
		loop: true,
		nav: true,
		dots: false,
		animateOut: 'fadeOut',
	...
	//Отправка цели в FaceBook
	$('a.btn, [name=web_form_submit]').click(function() {
		dataLayer.push({ event: 'Button' });
	});

	//Установка выбранного тарифа в попапе
	$('[href=#popup03]').click(function() {
		$('[name=SIMPLE_FORM_23]')
			.find('.jq-radio')
			.removeClass('checked');
		var tarif = $(this)
			...
			.children('.heading')
			.text();
		$($('[tarif=' + tarif + ']')[0]).attr('checked', true);
		var fieldID = $('[tarif=' + tarif + ']').attr('id');
		$('#' + fieldID + '-styler').addClass('checked');
	});

	//Открываем список отзывов по 4
	$('#more_reviews').click(function() {
		$('.reviews-blocks .block.hide:lt(4)').fadeIn(300, function() {
			$(this).removeClass('hide');

			if ($('.reviews-blocks .block.hide').length == 0) {
				$('#more_reviews').hide();
			}
		});
	});
	$('form').submit(function() {
		ga('send', 'event', 'obshaya', 'done');
		yaCounter981104.reachGoal('obshaya_done');
	});
...
function initClearInput() {
	$('input[type=text], input[type=tel], input[type=textarea]').click(function() {
		if (
			$(this)
				.parent()
				.hasClass('error')
...
function animateBlock() {
	$('.jsToAnimate').each(function() {
		...
		var animateElement = $('.jsToAnimate'),
			elementOffset = animateElement.offset(),
			elementOffsetTop = elementOffset.top + 150;

		if (elementOffsetTop < maxTop) {
			$('#' + animateElement.attr('id'))
				.addClass('custom-animate')
				.removeClass('jsToAnimate');
		}
	});
}

function jsToForm() {
	$('.jsToForm').on('click', function(event) {
		event.preventDefault();
		var vWidth = $(window).width();
		var currentOffset = $('#header').offset().top != 0;
		console.log(currentOffset);
		if (vWidth < 768) {
			var scrollTop = $('.question-section').offset().top - 70;
			console.log('70');
		} else if (($('.three-level').length > 0) & currentOffset) {
			var scrollTop = $('.question-section').offset().top - 44;
			console.log('44');
		} else if (($('.three-level').length > 0) & !currentOffset) {
			var scrollTop = $('.question-section').offset().top - 98;
			console.log('98');
		} else {
			var scrollTop = $('.question-section').offset().top - 63;
			console.log('63');
		}
		$('html , body').animate({ scrollTop: scrollTop }, 500);
	});
...
function jsToReviews() {
	$('.jsToReviews').on('click', function(event) {
		event.preventDefault();
		var vWidth = $(window).width();
		if (vWidth < 768) {
			var scrollTop = $('.reviews-section').offset().top - 70;
		} else {
			var scrollTop = $('.reviews-section').offset().top - 63;
		}
		$('html , body').animate({ scrollTop: scrollTop }, 500);
	});
}
...
function jsToTasks() {
	$('.jsToTasks').on('click', function(event) {
		event.preventDefault();
		var vWidth = $(window).width();
		if (vWidth < 768) {
			var scrollTop = $('.tasks-section').offset().top - 70;
		} else {
			var scrollTop = $('.tasks-section').offset().top - 50;
		}
		$('html , body').animate({ scrollTop: scrollTop }, 500);
	});
}

function jsMaxWidthImage() {
	var imagesPixeleted = $(
		'.item .graph img, .audit-gallery .item img, .tools-gallery .item img, .analitic-section img, .about-work .mobile-hidden img'
	);
	setTimeout(function() {
		imagesPixeleted.each(function() {
			var src = $(this).attr('src');
			var extArray = src.split('.');
			if (extArray[extArray.length - 1] == 'svg') {
				return;
			}
			var theImage = new Image();
			theImage.src = src;
			var imageWidth = theImage.width;
			console.log(imageWidth, theImage.src);
...
function initLevelMenu() {
	if ($('.header-frame').length) {
		$('body').addClass('three-level');
	} else {
		$('body').addClass('two-level');
	}
	if ($('#bx-panel').length) {
		$('body')
			.removeClass('three-level')
			.removeClass('two-level')
			.addClass('admin-mode');
	}
}
...
function menuBehavior() {
	...
	var adminMode = $('#bx-panel').length > 0;
	if (!adminMode) {
		...
		$(window).scroll(function() {
			...
			} else if (scrollTop > currentScrollTop && $(window).scrollTop() > 40) {
				// downscroll code
				$('body').addClass('scrolling-down');
				$('body').removeClass('scrolling-up');
			} else {
				// upscroll code
				if (scrollTop - bottom > 750 || bottom - scrollTop > 750) {
					console.log('=================== MENU =================');
...
$(function() {
	window.onload = function() {
		...
		$('a.mail').text('sales+' + roistat + '@webit.ru');
	};
});
...
//   if (result_carousel && result_carousel.length > 0) {
//     result_carousel.trigger('refresh.owl.carousel');
//   }
// });
...
$(document).ready(function() {
	$('.programmic-list').masonry({
		// options
		itemSelector: '.programmic-list img',
		// columnWidth: 330
	});
});

//функция аналог php функции nubmer_format
...
function calculate() {
	var calculator = $('#target_calc');
	var clicks = $(calculator)
		.find('input.amount')
		.val();
	var result = 0;
	var am_val = 0;
	...
	var am = $(calculator)
		.find('#check-field1200')
		.is(':checked');
	var vk = $(calculator)
		.find('#check-field1201')
		.is(':checked');
	var od = $(calculator)
		.find('#check-field1202')
		.is(':checked');
	var fb = $(calculator)
		.find('#check-field1203')
		.is(':checked');
	var inst = $(calculator)
		.find('#check-field1204')
		.is(':checked');
	if (clicks == '4000+') {
		$(calculator)
			.find('.calc-total-title span')
			.html('&nbsp;');
		$(calculator)
			.find('.calc-total-result span')
			.html('Ваш бюджет рассчитывается индивидуально')
			.addClass('calculate_individual');
	} else {
		var countSocials = 0;
		var resultSocials = 0;
		if (am) {
		...
		if (countSocials == 0) {
			...
			resultSocials = (vk_val + od_val + fb_val + inst_val) / countSocials;
		}

		$(calculator)
			.find('.calc-total-title span')
			.html('Ваш рекламный бюджет');
		result = clicks * resultSocials + am_val;
		result = number_format(result, 0, '.', ' ');

		$(calculator)
			.find('.calc-total-result span')
			.html(result + ' ₽')
			.removeClass('calculate_individual');
	}
}

$(document).ready(function() {
	$('.main-calc #check-field1200').change(function() {
		calculate();
	});
	$('.main-calc #check-field1201').change(function() {
		calculate();
	});
	$('.main-calc #check-field1202').change(function() {
		calculate();
	});
	$('.main-calc #check-field1203').change(function() {
		calculate();
	});
	$('.main-calc #check-field1204').change(function() {
		calculate();
	});
	$('#target_calc input.amount').change(function() {
		calculate();
	});

	// $('.static-popup').click(function() {
	//   $.fancybox.open({
	//     src: "#popup07",
	//     type: "inline",
	//     clickSlide : false,
...
function addData(data) {
	var calculatorBlock = $('#target_calc');
	var clicksCount = $(calculatorBlock)
		.find('input.amount')
		.val();

	var res = '';
	var am = $(calculatorBlock)
		.find('#check-field1200')
		.is(':checked');
	var vk = $(calculatorBlock)
		.find('#check-field1201')
		.is(':checked');
	var od = $(calculatorBlock)
		.find('#check-field1202')
		.is(':checked');
	var fb = $(calculatorBlock)
		.find('#check-field1203')
		.is(':checked');
	var inst = $(calculatorBlock)
		.find('#check-field1204')
		.is(':checked');
	res = $(calculatorBlock)
		.find('.calc-total-result span')
	...
	$('#form_text_133').val(clicksCount);
	if (am) {
		$('#form_text_132').val('Да');
	} else {
		$('#form_text_132').val('Нет');
	}
	if (vk) {
		$('#form_text_134').val('Да');
	} else {
		$('#form_text_134').val('Нет');
	}
	if (od) {
		$('#form_text_135').val('Да');
	} else {
		$('#form_text_135').val('Нет');
	}
	if (fb) {
		$('#form_text_136').val('Да');
	} else {
		$('#form_text_136').val('Нет');
	}
	if (inst) {
		$('#form_text_137').val('Да');
	} else {
		$('#form_text_137').val('Нет');
	}
	$('#form_text_138').val(res);
}

function calculate_programmatic() {
	var calculator = $('#programmatic_calc');
	var budget = $(calculator)
		.find('input.amount')
		.val();
	var result = 0;
	var am_val = 0;
	...
	var am = $(calculator)
		.find('#check-field1300')
		.is(':checked');
	var checkedPrice = 0;
	var checkedPrice = $('#programmatic_calc .right-calc-block .check-theme input:checked').data('price');
	...
	if (checkedPrice) {
		resultClicks = (budget - am_val) / checkedPrice;
	}

	if (resultClicks > 0) {
		resultClicks = number_format(resultClicks, 0, '.', ' ');
...
function addDataProgrammatic(data) {
	var calculatorBlock = $('#programmatic_calc');
	var budget = $(calculatorBlock)
		.find('input.amount')
		.val();
	...
	var am = $(calculatorBlock)
		.find('#check-field1300')
		.is(':checked');
	var nedv = $(calculatorBlock)
		.find('#check-field1301')
		.is(':checked');
	var stroy = $(calculatorBlock)
		.find('#check-field1302')
		.is(':checked');
	var fin = $(calculatorBlock)
		.find('#check-field1303')
		.is(':checked');
	var med = $(calculatorBlock)
		.find('#check-field1304')
		.is(':checked');
	var trans = $(calculatorBlock)
		.find('#check-field1305')
		.is(':checked');
	var kras = $(calculatorBlock)
		.find('#check-field1306')
		.is(':checked');
	var meb_got = $(calculatorBlock)
		.find('#check-field1307')
		.is(':checked');
	var meb_zak = $(calculatorBlock)
		.find('#check-field1308')
		.is(':checked');
	var odej = $(calculatorBlock)
		.find('#check-field1309')
		.is(':checked');
	var zif = $(calculatorBlock)
		.find('#check-field1310')
		.is(':checked');
	var rem = $(calculatorBlock)
		.find('#check-field1311')
		.is(':checked');
	var tur = $(calculatorBlock)
		.find('#check-field1312')
		.is(':checked');
	var auto = $(calculatorBlock)
		.find('#check-field1313')
		.is(':checked');
	var prom = $(calculatorBlock)
		.find('#check-field1314')
		.is(':checked');
	var it = $(calculatorBlock)
		.find('#check-field1315')
		.is(':checked');
	var delov = $(calculatorBlock)
		.find('#check-field1316')
		.is(':checked');
	var potreb = $(calculatorBlock)
		.find('#check-field1317')
		.is(':checked');
	res = $(calculatorBlock)
		.find('.calc-total-result span')
		.text();

	$('#form_text_116').val(budget);
	if (am) {
		$('#form_text_115').val('Да');
	} else {
		$('#form_text_115').val('Нет');
	}
	if (nedv) {
		$('#form_text_117').val('Да');
	} else {
		$('#form_text_117').val('Нет');
	}
	if (stroy) {
		$('#form_text_118').val('Да');
	} else {
		$('#form_text_118').val('Нет');
	}
	if (fin) {
		$('#form_text_119').val('Да');
	} else {
		$('#form_text_119').val('Нет');
	}
	if (med) {
		$('#form_text_120').val('Да');
	} else {
		$('#form_text_120').val('Нет');
	}
	if (trans) {
		$('#form_text_121').val('Да');
	} else {
		$('#form_text_121').val('Нет');
	}
	if (kras) {
		$('#form_text_122').val('Да');
	} else {
		$('#form_text_122').val('Нет');
	}
	if (meb_got) {
		$('#form_text_123').val('Да');
	} else {
		$('#form_text_123').val('Нет');
	}
	if (meb_zak) {
		$('#form_text_124').val('Да');
	} else {
		$('#form_text_124').val('Нет');
	}
	if (odej) {
		$('#form_text_125').val('Да');
	} else {
		$('#form_text_125').val('Нет');
	}
	if (zif) {
		$('#form_text_126').val('Да');
	} else {
		$('#form_text_126').val('Нет');
	}
	if (rem) {
		$('#form_text_127').val('Да');
	} else {
		$('#form_text_127').val('Нет');
	}
	if (tur) {
		$('#form_text_128').val('Да');
	} else {
		$('#form_text_128').val('Нет');
	}
	if (auto) {
		$('#form_text_129').val('Да');
	} else {
		$('#form_text_129').val('Нет');
	}
	if (prom) {
		$('#form_text_130').val('Да');
	} else {
		$('#form_text_130').val('Нет');
	}
	if (it) {
		$('#form_text_131').val('Да');
	} else {
		$('#form_text_131').val('Нет');
	}
	if (delov) {
		$('#form_text_132').val('Да');
	} else {
	...
	if (potreb) {
		$('#form_text_133').val('Да');
	} else {
		$('#form_text_133').val('Нет');
	}
	$('#form_text_134').val(res);
}

$(document).ready(function() {

	$('#cookie-modal-close').on('click', function(e) {
        e.preventDefault();
        BX.setCookie('cookie-modal', 'closed', {expires: 86400, path: '/'});
        $('.cookie-modal').removeClass('active');
    });

	$('#programmatic_calc .check-theme div.jq-checkbox').on('click', function() {
		$('#programmatic_calc .check-theme div.jq-checkbox').removeClass('checked');
		$('#programmatic_calc .check-theme input').prop('checked', false);
	...
	$('#programmatic_calc #check-field1300').change(function() {
		calculate_programmatic();
	});
	$('#programmatic_calc input.amount').change(function() {
		calculate_programmatic();
  });
});
...
* Документация: https://owlcarousel2.github.io/OwlCarousel2/docs/api-options.html
 */
 function initCarousel(){
  $('#main-page-sl').owlCarousel({
    loop:true,
    animateOut: 'fadeOut',
    autoplay:true,
  ...
  $('.main__cases-next').click(function(e) {
    e.preventDefault()
    console.log('nxt')
    $('#main-page-sl').trigger('next.owl.carousel');
  })
  $('.main__cases-prev').click(function() {
    console.log('prev')
    $('#main-page-sl').trigger('prev.owl.carousel');
  })
...
function initMainSlider(){
  var textCarousel = $('.main-cases__text-block');
//   var pictureCarousel = $('.main-cases__picture-wrapper');
//   pictureCarousel.owlCarousel({
//     margin:10,
//     loop:true,
//     items:1,
//     touchDrag: false,
...
//   });
  ...
  $('.main__cases-prev').on('click', function(e){
    e.preventDefault();
    textCarousel.trigger('prev.owl.carousel', [500]);
    // pictureCarousel.trigger('prev.owl.carousel', [500]);
  })
  $('.main__cases-next').on('click', function(e){
    e.preventDefault();
    textCarousel.trigger('next.owl.carousel', [1000]);
    // pictureCarousel.trigger('next.owl.carousel', [1000]);
  })
}
/**
...
/**
* Инициализация Scrollto
 */
function initScrollTo() {
  $('.main__banner-btn').on('click', function(e){
    e.preventDefault();
    $('html,body').animate({
      scrollTop: $(".main-cases").offset().top - 200
    }, 1000);
  })
 }

/**
 * Разные функции для планшетной версии
 */
 function initTabletElements() {
  if (window.matchMedia('(max-width: 1280px)').matches) {
    
  }
  if (window.matchMedia('(max-width: 1024px)').matches) {
    $('.main__price-card-list').owlCarousel({
      loop:true,
      nav: false,
      dots: true,
      slideBy: 1,
    ...
    $('.main__reviews-list').owlCarousel({
      loop:true,
      items:1,
      margin:10,
      smartSpeed:450,
...
/**
 * Разные функции для мобильной версии
 */
function initMobileElements() {
  ...
  $('.single-case__fancy').fancybox()
  $('.single-case__image-show').on('click', function(){
    $('.single-case__fancy').click();
  })
}
// New-main
$(function() {
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:69:"/local/templates/webit/js/jquery.ui.touch-punch.min.js?15495297831291";s:6:"source";s:54:"/local/templates/webit/js/jquery.ui.touch-punch.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/*!
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:63:"/local/templates/webit/js/jquery.activity.min.js?15180855021572";s:6:"source";s:48:"/local/templates/webit/js/jquery.activity.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:42:"/js/jquery-site.activity.js?15180857195808";s:6:"source";s:27:"/js/jquery-site.activity.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/**
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:57:"/local/templates/webit/js/lazysizes.min.js?15901378927775";s:6:"source";s:42:"/local/templates/webit/js/lazysizes.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:61:"/local/templates/webit/js/masonry.pkgd.min.js?159013789224103";s:6:"source";s:45:"/local/templates/webit/js/masonry.pkgd.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/*!
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:53:"/local/templates/webit/js/yandex_map.js?1548856973585";s:6:"source";s:39:"/local/templates/webit/js/yandex_map.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
ymaps.ready(init);
var myMap, myPlacemark;
function init () {
	var myMap = new ymaps.Map("map", {
		center: [55.8129909, 37.6327129],
		zoom:16,
	...
	myMap.geoObjects
	.add(new ymaps.Placemark([55.8129909, 37.6327129], {
			balloonContent: 'Webit'
	}, {
		iconLayout: 'default#image',
		iconImageHref: '/images/contacts/place_large.svg',
		iconImageSize: [66, 98],
		iconImageOffset: [-48, -95]
	}));
}
/* End */
;
; /* Start:"a:4:{s:4:"full";s:81:"/local/templates/webit/components/bitrix/menu/top_new/script.min.js?1586968415409";s:6:"source";s:63:"/local/templates/webit/components/bitrix/menu/top_new/script.js";s:3:"min";s:67:"/local/templates/webit/components/bitrix/menu/top_new/script.min.js";s:3:"map";s:67:"/local/templates/webit/components/bitrix/menu/top_new/script.map.js";}"*/
var jsvhover=function(){var e=document.getElementById("vertical-multilevel-menu");if(!e)return;var t=e.getElementsByTagName("li");for(var n=0;n<t.length;n++){t[n].onmouseover=function(){this.className+=" jsvhover"};t[n].onmouseout=function(){this.className=this.className.replace(new RegExp(" jsvhover\\b"),"")}}};if(window.attachEvent)window.attachEvent("onload",jsvhover);
/* End */
;
; /* Start:"a:4:{s:4:"full";s:88:"/local/templates/webit/components/bitrix/menu/top_new_mobile/script.min.js?1586968415409";s:6:"source";s:70:"/local/templates/webit/components/bitrix/menu/top_new_mobile/script.js";s:3:"min";s:74:"/local/templates/webit/components/bitrix/menu/top_new_mobile/script.min.js";s:3:"map";s:74:"/local/templates/webit/components/bitrix/menu/top_new_mobile/script.map.js";}"*/
var jsvhover=function(){var e=document.getElementById("vertical-multilevel-menu");if(!e)return;var t=e.getElementsByTagName("li");for(var n=0;n<t.length;n++){t[n].onmouseover=function(){this.className+=" jsvhover"};t[n].onmouseout=function(){this.className=this.className.replace(new RegExp(" jsvhover\\b"),"")}}};if(window.attachEvent)window.attachEvent("onload",jsvhover);
/* End */
;; /* /local/templates/webit/js/jquery-latest.min.js?159013789295786*/
; /* /local/templates/webit/js/jquery-ui.js?1590137892252417*/
; /* /local/templates/webit/js/owl.carousel.min.js?151778794179152*/
; /* /local/templates/webit/js/jquery.fancybox.js?151778793552723*/
; /* /local/templates/webit/js/imask.js?1559718999137514*/
; /* /local/templates/webit/js/jquery.mCustomScrollbar.concat.min.js?155843771645479*/
; /* /local/templates/webit/js/jquery.formstyler.js?151778793740414*/
; /* /local/templates/webit/js/menu.js?15906501353693*/
; /* /local/templates/webit/js/progressbar.min.js?155843771622540*/
; /* /local/templates/webit/js/global.js?160164832653544*/
; /* /local/templates/webit/js/fotorama.js?151778793438913*/
; /* /local/templates/webit/js/jquery.ui.touch-punch.min.js?15495297831291*/
; /* /local/templates/webit/js/jquery.activity.min.js?15180855021572*/
; /* /js/jquery-site.activity.js?15180857195808*/
; /* /local/templates/webit/js/lazysizes.min.js?15901378927775*/
; /* /local/templates/webit/js/masonry.pkgd.min.js?159013789224103*/
; /* /local/templates/webit/js/yandex_map.js?1548856973585*/
; /* /local/templates/webit/components/bitrix/menu/top_new/script.min.js?1586968415409*/
; /* /local/templates/webit/components/bitrix/menu/top_new_mobile/script.min.js?1586968415409*/

//# sourceMappingURL=template_e373fd47a4fca7591af23fe9823d7159.map.js